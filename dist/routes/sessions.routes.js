...
sessionsRouter.post('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, authentication, _b, user, token;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _a = request.body, email = _a.email, password = _a.password;
                authentication = new AuthenticateUserService_1.default();
                return [4 /*yield*/, authentication.execute({ email: email, password: password })];
            case 1:
