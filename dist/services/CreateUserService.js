...
var CreateUserService = /** @class */ (function () {
    ...
    CreateUserService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var userRepository, zeroPoints, checkUserExists, checkUserNicknameExists, user;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        checkUserNicknameExists = _b.sent();
                        if (checkUserExists) {
                            throw new AppError_1.default('Email address already used.');
                        }
                        if (checkUserNicknameExists) {
                            throw new AppError_1.default('Nickname already used.');
                        }
